...
export const queryKeys = {
  ...
  // Permit Requests keys
  permitRequests: {
    all: ["permitRequests"] as const,
    lists: () => [...queryKeys.permitRequests.all, "list"] as const,
    list: (params?: Record<string, any>) =>
      [...queryKeys.permitRequests.lists(), params] as const,
    details: () => [...queryKeys.permitRequests.all, "detail"] as const,
    detail: (id: string | number) =>
      [...queryKeys.permitRequests.details(), id] as const,
  },
} as const;
