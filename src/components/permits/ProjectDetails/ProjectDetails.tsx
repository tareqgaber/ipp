...
import ConsultantInformation from "./components/ConsultantInformation"
import Contractorinformation from "./components/Contractorinformation"
import ExcavationDetails from "./components/ExcavationDetails"
...
const ProjectDetails = () => {
    return (
        <div className="flex flex-col gap-5 pb-5">
            ...
            <ConsultantInformation data={data} />
            <Contractorinformation data={data} />
        </div>
    )
}
