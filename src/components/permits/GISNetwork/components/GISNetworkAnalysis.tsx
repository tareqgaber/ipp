        ...
        <div className='bg-white w-full h-auto rounded-xl pb-5'>
            <div className='px-4 sm:px-6 pt-4 sm:pt-5 pb-4 sm:pb-[21px] flex justify-between items-center border-b border-[#E9EAEB]'>
                ...
                <button className='py-2.5 cursor-pointer hover:bg-gray-100 px-4 sm:px-5 gap-1 flex items-center bg-white border border-[#D5D7DA] rounded-lg'>
                    <RetryIcon  />
                    <h3 className='text-[12px] sm:text-[14px] font-semibold text-[#414651]'>Retry</h3>
                </button>
            </div>
                ...
                <div className='flex flex-col gap-4 w-full lg:w-7/12'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-0'>
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-[12px] sm:text-[14px] font-normal text-[#374151]'>GIS Analysis</h2>
                            <div className='flex items-center gap-2'>
                                <Toggle size="sm" />
                                <h6 className='text-[#414651] text-[10px] sm:text-[12px] font-semibold'>Conflict</h6>
                            </div>
                        </div>
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-[12px] sm:text-[14px] font-normal text-[#374151]'>VIP</h2>
                            <div className='flex items-center gap-2'>
                                <Toggle size="sm" />
                                <h6 className='text-[#414651] text-[10px] sm:text-[12px] font-semibold'>Conflict</h6>
                            </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-0'>
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-[12px] sm:text-[14px] font-normal text-[#374151]'>National Grid</h2>
                            <div className='flex items-center gap-2'>
                                <Toggle size="sm" />
                                <h6 className='text-[#414651] text-[10px] sm:text-[12px] font-semibold'>Conflict</h6>
                            </div>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h2 className='text-[12px] sm:text-[14px] font-normal text-[#374151]'>Distribution</h2>
                            <div className='flex items-center gap-2'>
                                <Toggle size="sm" />
                                <h6 className='text-[#414651] text-[10px] sm:text-[12px] font-semibold'>Conflict</h6>
                            </div>
                    ...
                    <div className='relative'>
                        <TextArea
                            ...
                            rows={5}
                        />
                        <button className='py-2 bg-white absolute bottom-3 left-3.5 px-3 font-medium text-[14px] sm:text-[16px] text-[#181D27] border border-[#D5D7DA] rounded-lg cursor-pointer'>Insert Template</button>
                    </div>
                </div>
                ...
                <div className='px-4 sm:px-6 pt-4 sm:pt-5 pb-4 mb-4 sm:pb-[21px] flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0 border-b border-[#E9EAEB]'>
                    ...
                    <div className='flex items-center gap-2 sm:gap-4 flex-wrap'>
                        <button className='py-2.5 cursor-pointer px-3 sm:px-3.5 gap-1 flex items-center bg-[#144892] rounded-lg'>
                            <UploadIcon  />
                            <h3 className='text-[12px] sm:text-[14px] font-semibold text-white'>Upload</h3>
                        </button>
                        <button className='py-2.5 cursor-pointer border border-[#A4A7AE] px-3 sm:px-3.5 gap-1 flex items-center bg-white rounded-lg'>
                            <DownloadIcon2 />
                            <h3 className='text-[12px] sm:text-[14px] font-semibold text-[#A4A7AE]'>Download</h3>
                        </button>
            ...
            <div className='gap-6 pl-4 flex items-center mt-6'>
                <button className='py-2.5 px-5 rounded-lg bg-[#144892] text-[12px] sm:text-[14px] font-semibold cursor-pointer text-white'>Save & Submit</button>
                <button className='py-2.5 px-5 rounded-lg bg-white text-[12px] border border-[#D5D7DA] cursor-pointer sm:text-[14px] font-semibold text-[#414651]'>Save</button>
            </div>
        </div>
    )
}
