...
const Sidebar: React.FC<SidebarProps> = ({ collapsed = false, onToggle, onCloseMobile }) => {
    ...
    return (
        <section className='relative h-screen overflow-hidden'>
            <div className={`absolute z-0 -bottom-40 ${isRTL ? 'right-0' : 'left-0'} hidden lg:block`}>
                <Flag
            ...
            <aside className={`
                ...
                ${collapsed ? 'w-16 lg:w-14 lg:px-2' : 'w-[250px] lg:w-[215px] lg:px-5'} 
